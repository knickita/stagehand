...
class Stagehand_MT_menu(bpy.types.Menu):
    ...
    def draw(self, context):
        self.layout.operator("stagehand.open_controls", text="StagehandControls", icon='TOOL_SETTINGS')
        ...
        self.layout.operator("stagehand.add_cable_anchor_plane", text="Add Cable Anchor Plane")
