...
class StagehandLinkType(IntEnum):
    ...
    SELVOLINE_SEDE_TRAVETTA = 35
    SELVOLINE_TRAVETTA = 36
    SELVOLINE_SEDE_CAVALLA = 37
    SELVOLINE_CAVALLA = 38
    SELVOLINE_SEDE_TAVOLA = 39
    SELVOLINE_TAVOLA = 40
    SELVOLINE_MONTANTE = 41
    SELVOLINE_SEDE_MANCORRENTE = 42
...
LINK_COMPATIBILITY = {
    ...
    StagehandLinkType.SELVOLINE_SEDE_TRAVETTA: (
        StagehandLinkType.SELVOLINE_TRAVETTA,
        StagehandLinkType.SELVOLINE_MONTANTE,
    ),
    StagehandLinkType.SELVOLINE_TRAVETTA: (StagehandLinkType.SELVOLINE_SEDE_TRAVETTA,),
    StagehandLinkType.SELVOLINE_SEDE_CAVALLA: (StagehandLinkType.SELVOLINE_CAVALLA,),
    StagehandLinkType.SELVOLINE_CAVALLA: (StagehandLinkType.SELVOLINE_SEDE_CAVALLA,),
    StagehandLinkType.SELVOLINE_SEDE_TAVOLA: (StagehandLinkType.SELVOLINE_TAVOLA,),
    StagehandLinkType.SELVOLINE_TAVOLA: (StagehandLinkType.SELVOLINE_SEDE_TAVOLA,),
    StagehandLinkType.SELVOLINE_MONTANTE: (StagehandLinkType.SELVOLINE_SEDE_TRAVETTA,),
    StagehandLinkType.SELVOLINE_SEDE_MANCORRENTE: (StagehandLinkType.SELVOLINE_MANCORRENTE,),
